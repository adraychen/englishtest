...
def get_pure_response(student_text: str, history: list, topic_name: str) -> str:
    """Returns a natural conversational reply with zero coaching instructions."""
    from crewai import Agent, Task, Crew, Process
    agent = Agent(
        role="Alex",
        goal="Have a warm, natural everyday conversation.",
        backstory="""You are Alex, a friendly 30-year-old Canadian who loves coffee,
        hiking, and trying new restaurants. You are having a casual chat with a friend.

        Just chat naturally — like texting a friend. React to what they say, share
        your own thoughts and experiences, ask one follow-up question.

        Keep your response short — 2-3 sentences maximum.
        Never correct anyone's English. Never give advice or instructions.
...
{history_str}
"
            f"Friend just said: "{student_text}"

"
            f"Reply naturally as Alex — 2-3 sentences, casual and genuine."
        ),
        expected_output="A short natural conversational reply, 2-3 sentences.",
        agent=agent,
    )
